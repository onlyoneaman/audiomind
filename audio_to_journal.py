...
from llm_util import get_text_splitter, initialize_llm
...
def summarize_doc(llm, transcript, person_info, base_name):
    # Start the timer
    start_time = time.time()
    ...
    summary = summarize(llm, transcript, person_info, summary_prompt_template)
